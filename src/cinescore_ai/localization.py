...
GERMAN_TRANSLATIONS: dict[str, str] = {
    ...
    "Discord": "Discord",
    "Open the CineScore AI Discord community.": "Die CineScore-AI-Discord-Community öffnen.",
    "Project": "Projekt",
    "Timeline": "Timeline",
    ...
    "Retrying Gemini music generation with MP3 after WAV failure...": "Gemini-Musikerzeugung wird nach WAV-Fehler mit MP3 erneut gestartet...",
    "WAV fallback reason: {reason}": "Grund fuer WAV-Fallback: {reason}",
    ...
    "WAV generation failed": "WAV-Erzeugung fehlgeschlagen",
    "WAV generation failed due to:\n{reason}\n\nWould you like to retry once with MP3 instead?": "WAV-Erzeugung ist fehlgeschlagen wegen:\n{reason}\n\nMoechtest du stattdessen einmalig mit MP3 erneut versuchen?",
    "MP3 fallback was declined after WAV failure.": "MP3-Fallback wurde nach WAV-Fehler abgelehnt.",
    "MP3 fallback accepted. Retrying Gemini music generation.": "MP3-Fallback akzeptiert. Gemini-Musikerzeugung wird erneut gestartet.",
    "Error X: Gemini rejected the WAV response MIME parameter.": "Fehler X: Gemini hat den WAV-Parameter fuer den Antwort-MIME-Typ abgelehnt.",
    "Error Y: Gemini returned non-WAV audio while WAV was requested.": "Fehler Y: Gemini hat kein WAV-Audio geliefert, obwohl WAV angefordert war.",
    "WAV generation failed due to a WAV format/API mismatch.": "WAV-Erzeugung fehlgeschlagen wegen eines WAV-Format-/API-Konflikts.",
    ...
    "Could not open Discord community link: {url}": "Discord-Community-Link konnte nicht geöffnet werden: {url}",
}
